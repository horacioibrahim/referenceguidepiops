                ...
                <div className="container mx-auto max-w-6xl grid md:grid-cols-2 gap-12 items-center relative z-10">
                    <div className="space-y-8">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                            Inovação é <span className="text-blue-400">sobrevivência</span>
                        </h1>

                        <p className="text-xl text-slate-400 leading-relaxed max-w-lg">
                            Negócios não morrem por falta de esforço. Morrem por falta de direção. E direção vem de saber gerir entregas, iniciativas e inovação.
                        </p>
            ...
            <section id="problems" className="py-20 bg-slate-900/50">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Você sente que está sempre começando, mas nunca avançando?</h2>
                        <p className="text-slate-400 text-lg">As empresas mais valiosas do mundo são de software. Não por acaso — elas dominam a gestão de iniciativas e inovação. Sua empresa também precisa.</p>
                    </div>
...
export default LandingPageEntregas;
